...
function Jptitle1() {
  ...
  return (
    <div ref={ref}>
      <div className={'jp-title ' + (inView && 'fadeupJp')}>わたしたちについて</div>
    </div>
  )
}
function Subtitle1() {
  ...
  return (
    <div className='sub-title' ref={ref}>
      <h3 className={(inView && 'fadeup')}><span className=' big-subtitle'>VISEOは、</span><br />デジタル戦略の中核を担い、<br className='sp' />独立系で堅実な会社です。</h3>
    </div>
  )
}
function CardsArea() {
...
function DescText1() {
  ...
  return (
    <div ref={ref}>
      <p className={'desc-text ' + (inView && 'fadeup')}>デジタル領域にビジネスの変革をもたらして<br className='pc' />テクノロジー変革やイノベーションを起こします。</p>
    </div>
  )
}
function WorldWork() {
...
function ViseoText() {
  ...
  return (
    <div ref={ref}>
      <p className={'main-text pc ' + (inView && 'fadeup')}>シンガポール、マレーシア、セブ、シュラバヤ、香港、上海、深セン、東京、<br className='pc' />
...
function ViseoOffice() {
  ...
  return (
    <div ref={ref}>
      <img src={world_office} alt="" className={(inView && 'fadeup')} />
    </div>
  )
}
/* /section2 */
...
function Jptitle3() {
  ...
  return (
    <div ref={ref}>
      <div className={'jp-title ' + (inView && 'fadeupJp')}>わたしたちのサービス</div>
    </div>
  )
}
function Bluetitle1() {
  ...
  return (
    <div ref={ref}>
      <h3 className={'blue-title ' + (inView && 'fadeup')}>グローバルな専門知識 <br className='sp' />アプリケーションサービス</h3>
    </div>
  )
}
function Bluetitle2() {
  ...
  return (
    <div ref={ref}>
      <h3 className={'blue-title ' + (inView && 'fadeup')}>エンドトゥーエンドサポート</h3>
    </div>
  )
}
function Bluetitle3() {
  ...
  return (
    <div ref={ref}>
      <h3 className={'blue-title ' + (inView && 'fadeup')}>小売業のデジタル変革をリード</h3>
    </div>
  )
}
function ServiceImg1() {
  const { ref, inView } = useInView({
    // オプション
    rootMargin: "0px 0px -20% 0px", // ref要素が現れてから20%過ぎたら
    triggerOnce: true, // 最初の一度だけ実行
...
function Jptitle4() {
  ...
  return (
    <div ref={ref}>
      <div className={'jp-title ' + (inView && 'fadeupJp')}>わたしたちのパートナー</div>
    </div>
  )
}
